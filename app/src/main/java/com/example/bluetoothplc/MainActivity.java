...
public class MainActivity extends AppCompatActivity {
    ...
    public void showInformation(View view){
        Intent intent = new Intent(getApplicationContext(), com.example.omron.informacje.class );
        startActivity(intent);
    }

    public void showBtDevices(View view){
        Intent intent = new Intent(getApplicationContext(), com.example.omron.Bluetooth.class );
        startActivity(intent);
    }
